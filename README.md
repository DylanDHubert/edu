...
- 📚 **DOCUMENT SEARCH**: VECTOR-BASED SEARCH THROUGH UPLOADED PDF AND MARKDOWN DOCUMENTS
...
CREATE TABLE IF NOT EXISTS notes (
  ...
  images JSONB DEFAULT '[]'::jsonb, -- ARRAY OF IMAGES WITH URLS AND DESCRIPTIONS
  is_shared BOOLEAN DEFAULT FALSE,
  is_portfolio_shared BOOLEAN DEFAULT FALSE, -- SHARE ACROSS ALL ACCOUNTS IN PORTFOLIO
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
- UPLOAD ALL PDF AND MARKDOWN FILES TO OPENAI
...
1. UPLOAD PDF FILES THROUGH THE TEAM LAUNCHER INTERFACE
2. DOCUMENTS ARE AUTOMATICALLY PROCESSED INTO TEAM-SPECIFIC ASSISTANTS
3. NO MANUAL SETUP REQUIRED - SYSTEM IS FULLY AUTOMATED

### CUSTOMIZING ASSISTANTS

ASSISTANTS ARE DYNAMICALLY CREATED PER TEAM/ACCOUNT/PORTFOLIO COMBINATION.
